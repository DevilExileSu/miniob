...
public:
  ...
  RC init(const char *name, AttrType attr_type, int attr_offset, int attr_len, int index,  bool visible, bool nullable);
...
protected:
  ...
  int attr_offset_;
  int attr_len_;
  int index_;   // 记录field_meta的下标，用于更新null_bitmap
  bool visible_;
  bool nullable_;
};
